...
<body>
    ...
    $arr_faq = [
        [
            'domande' => '<h1>Come state implementando la recente decisione della Corte di giustizia dell\'Unione europea (CGUE) relativa al diritto all\'oblio?</h1>',
        ...
        [
            'domande' => '<h1>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h1>',
        ...
        [
            'domande' => '<h1>Perché il mio account è associato a un paese?</h1>',
            'risposta' => 'Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un\'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
            ...
            Scopri quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.  <p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
            <ol>
                <li class="smANld">La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol type="a">
                        <li class="smANld">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
        ...
        [
            'domande' => '<h1>Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?</h1>',
...
<?php
    ...
    // for($i=0; $i < count($arr_faq); $i++){
    //     echo "<h1>{$arr_faq[$i]['domande']}</h1>";
    //     echo $arr_faq[$i]['risposta'];
    // }
    foreach ($arr_faq as $i) {
